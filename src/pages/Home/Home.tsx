      ...
      <div className="relative z-10 mx-auto flex min-h-[calc(100dvh-4rem)] max-w-[1440px] items-center px-5 py-16 sm:px-8 lg:px-16 lg:py-20">
        ...
        >
          ...
          <div className="mt-10 flex w-fit items-center justify-center gap-9 sm:gap-15">
            ...
            <a href="https://mail.google.com/mail/?view=cm&fs=1&to=tushartushar7090@gmail.com&su=Portfolio%20Contact" target="_blank" rel="noreferrer" aria-label="Email Tushar" className="text-[#ea6a47] transition duration-200 hover:scale-110 hover:drop-shadow-[0_0_8px_rgba(234,106,71,0.4)]"><Mail size={28} /></a>
          </div>
        </motion.div>
      </div>
    </section>
